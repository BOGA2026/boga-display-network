...
import { TV_RULES, contrastRatio, blend } from "./tvLegibility";
import { ARCHETYPES, type ArchetypeId } from "./designArchetypes";
import { buildPieceLayout, LAYOUT_RULES, type LayoutInput, type PieceLayout } from "./pieceLayout";
