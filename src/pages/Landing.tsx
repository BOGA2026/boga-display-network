...
const Landing = () => {
  ...
  return (
    <PremiumBackground>
      ...
      {/* Hero */}
      <section className="relative overflow-hidden px-8 pb-24 pt-32 md:px-20 md:pt-40 lg:px-32 xl:px-40">
      ...
      {/* How It Works */}
      <section id="how" className="px-8 py-24 md:px-20 md:py-32 lg:px-32 xl:px-40">
      ...
      {/* Testimonials */}
      <section id="testimonials" className="relative px-8 py-24 md:px-20 md:py-32 lg:px-32 xl:px-40">
      ...
      {/* CTA */}
      <section className="px-8 py-24 md:px-20 md:py-32 lg:px-32 xl:px-40">
      ...
      {/* Footer */}
      <footer className="border-t border-border/20 px-8 py-14 md:px-20 lg:px-32 xl:px-40">
