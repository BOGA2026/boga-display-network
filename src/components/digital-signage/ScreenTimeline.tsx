  ...
  return (
    <div className="glass-card rounded-xl overflow-hidden">
          ...
          <div className="flex border-b border-border">
            ...
            <div className="flex flex-1">
              {HOURS.filter((h) => h % 3 === 0).map((h) => (
                <span
                  key={h}
                  className="flex-1 border-l border-border px-1 py-1 text-[10px] text-muted-foreground"
                >
      ...
      <div className="border-t border-border p-4 space-y-2">
        <p className="text-xs font-medium text-muted-foreground uppercase tracking-wider">Scheduled content</p>
