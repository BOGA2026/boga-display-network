...
export default function ScreenDetailKpis({ screen }: { screen: ScreenData }) {
  ...
  return (
    <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-5">
      <div className="v-card p-3 space-y-1">
        <p className="v-kpi-label">Estado</p>
      ...
      <div className="v-card p-3 space-y-1">
        ...
        <p className="v-kpi-value v-kpi-value-sm v-numeric">{screen.volume}%</p>
      </div>
      ...
      <div className="v-card p-3 space-y-1">
        ...
        <p className="v-kpi-value v-kpi-value-sm truncate">{screen.timezone}</p>
      </div>
    </div>
  );
}
